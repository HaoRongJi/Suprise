...
public abstract class JingDongCallBack<T> extends Callback<T> {
    ...
    public JingDongCallBack(Class targetClazz, Context context, boolean isShowDialog) {
        mClass = targetClazz;
        mContext = context;
        mIsShowDialog = isShowDialog;
    }

    public JingDongCallBack(Class<T> targetClazz, Context mContext) {
